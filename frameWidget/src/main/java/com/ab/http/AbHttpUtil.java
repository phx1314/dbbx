...
public class AbHttpUtil {
     ...
     */
    public void get(String url, AbRequestParams params,
                    AbFileHttpResponseListener responseListener, boolean noCookie) {
        mClient.get (url, params, responseListener,noCookie);
    }
    ...
    public void post(String url, AbRequestParams params,
                     AbHttpResponseListener responseListener, boolean noCookie) {
        mClient.post(url, params, responseListener, noCookie);
    }
